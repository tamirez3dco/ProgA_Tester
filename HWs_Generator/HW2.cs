...
namespace HWs_Generator
{
    public class HW2 : HW1
    {
        ...
        public override void Create_DocFile_By_Creators(Object[] args, List<Creators> creators)
        {
            ...
            par1.Range.Text = "ש\"ב 1 נועדו לתרגל אתכם על לולאות ומשפטי בקרה כפי שנלמדו בהרצאה ובתרגול. כרגיל, עליכם לייצר בדיוק את הפלט המצופה כדי שהבודק האוטומטי לא יכשיל אתכם. ושוב כרגיל, דוגמא לפלט המצופה מופיעה בסוף המסמך הזה.";
            par1.Range.InsertParagraphAfter();
